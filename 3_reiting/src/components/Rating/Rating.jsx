  ...
  return (
    ...
    {/* <div className="rating-container"> */}
      ...
      <div className="rating-buttons">
        <button className="rating-button" onClick={() => setRatingValue(0)}>Плохо</button>
        <button className="rating-button" onClick={() => setRatingValue(1)}>Приемлемо</button>
        <button className="rating-button" onClick={() => setRatingValue(2)}>Хорошо</button>
        <button className="rating-button" onClick={() => setRatingValue(3)}>Отлично</button>
      </div>
    {/* </div> */}
    </>
  );
